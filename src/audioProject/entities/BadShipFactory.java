...
public class BadShipFactory {
	...
	public static Entity makeDefaultEnemy(final Vector2 screen) {
		...
		HermiteKeyFrame k2 = new HermiteKeyFrame(new Vector2(0, (float) random() * screen.y), 8000 * (1 - AudioProject.controller.getFeel()));
	...
	public static Entity makePathedEnemy(final HermiteKeyFrameInterpolator path) {
		...
		entity.addScript(new EntityScriptAdapter() {
			...
			float allTime;
			final float health = 10 + 50 * AudioProject.controller.getFeel();
			...
			public void onSpawn(Entity self, Level level) {
				...
				entity.setDim(new Vector2(health));
			}
