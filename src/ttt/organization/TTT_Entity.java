...
public class TTT_Entity implements XMLSerializeable {
    ...
    public void assembleFromElement(Element entity) {
        ...
        types.assembleFromElement(entity.getChildElements(types.getElementName()).get(0));
        scripts.assembleFromElement(entity.getChildElements(scripts.getElementName()).get(0));
