...
public class TTT_VariableCase implements XMLSerializeable {
    ...
    public TTT_VariableCase() {
        ...
        setString(TTT_Constants.ID_KEY, "DEFAULT");
    }
    ...
    public Element writeToElement() {
        ...
        for (Entry<String, Object> s : this.variables.entrySet()) {
            ...
            var.addAttribute(new Attribute("type", (s.getValue() instanceof Float ? "Float" : "String")));
    ...
    public void assembleFromElement(Element entity) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            variables.put(variable.getLocalName(), type.equals("Float") ? Float.parseFloat(variable.getValue())
                    : variable.getValue());
        }
    }
    ...
    public String toString() {
        ...
        bu.append("VARIABLES [\n");
        for (Entry<String, Object> s : this.variables.entrySet()) {
            bu.append("\t").append(s.getKey()).append(": ").append(s.getValue().toString()).append("\n");
        }
