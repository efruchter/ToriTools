...
import java.awt.Graphics2D; //preserve this
import java.awt.GraphicsDevice;
import java.awt.GraphicsEnvironment;
import java.awt.Image;
import java.awt.RenderingHints; //preserve this
...
public class SampleGame
{
	...
	/**
	 * Sets full screen or reverts screen to normal.
	 * In the future, this method will be able to restore to windowed mode and not simply hide it.
	 * 
	 * To my knowledge, full screen only supports one monitor, for I have no other monitors to test with.
	 * 
	 * @param isFullScreen Enable (true) or disable (false) full screen mode?
	 */
	public void setFullScreen(boolean isFullScreen)
	{
		if (isFullScreen)
		{
			...
			if (displayMode != null && gd.isDisplayChangeSupported()) //displayMode has settings and video card can change display
			{
				try
				{
					gd.setDisplayMode(displayMode);
				}
				catch (Exception e)	{System.out.println("Son of a firing weapon!  Error!");}
			}
		}
		else
		{
	...
	public void setGlobalVar(final String key, final String value) {
		globalVariables.put(key, value);
	}

	public String getGlobalVar(final String key) {
