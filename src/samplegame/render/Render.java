...
public class Render {
	...
	/**
	 * Push a matrix polygon. Does not set color or fill style.
	 */
	...
	public static void drawRect(final Vector2f pos, final Vector2f dim) {
		drawPoly(pos, new Vector2f(pos.x + dim.x, pos.y),
